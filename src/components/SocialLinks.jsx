...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ngoc-ly-tran-46475926b/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@henry__ssi",
    icon: Instagram,
    url: "https://www.instagram.com/henry__ssi/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@henry18042k",
    icon: Github,
    url: "https://github.com/henry18042k",
    color: "#ffffff",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        {/* LinkedIn - Primary Row (Cố định ở vị trí đầu tiên) */}
        <a
          href={linkedIn.url}
          target="_blank"
        ...
        {/* Second Row - Instagram & GitHub (Hiển thị song song đẹp mắt) */}
